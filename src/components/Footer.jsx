...
export default function Footer() {
  return (
    <footer className="w-full bg-primary-container text-white">
      <div className="grid grid-cols-1 md:grid-cols-4 gap-gutter px-4 md:px-margin-desktop py-16 max-w-container-max mx-auto">
        ...
        <div className="space-y-6">
          ...
          <div className="flex gap-4">
            <a className="w-10 h-10 rounded-full bg-white/10 flex items-center justify-center hover:bg-white/20 transition-all text-white" href="#" aria-label="Share">
              <span className="material-symbols-outlined text-sm">share</span>
            </a>
            <a className="w-10 h-10 rounded-full bg-white/10 flex items-center justify-center hover:bg-white/20 transition-all text-white" href="#" aria-label="Website">
        ...
        {/* Links */}
        <div>
          <h4 className="font-body-lg font-bold text-white mb-6">Useful Links</h4>
          <ul className="space-y-3 font-body-md text-body-md text-white/80">
            {[
              { label: 'Home', to: '/' },
      ...
      <div className="border-t border-white/10 px-4 md:px-margin-desktop py-8 max-w-container-max mx-auto text-center md:text-left flex flex-col md:flex-row justify-between items-center font-label-sm text-label-sm text-white/60 gap-4">
